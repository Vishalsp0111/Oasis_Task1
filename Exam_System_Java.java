package Task1;
import java.util.*;
class Exam_System_Java {

Scanner sc = new Scanner(System.in);
HashMap<String,Integer> data = new HashMap<String,Integer>();

	public void login() {
		data.put("Vishal",4813);
		data.put("Vishal",2002);
...
//Question starts
	while(System.currentTimeMillis()<endtime) {
		...
		System.out.println("\n\nQ.1) Who won the Best Footballer 2022 in the World?");
...
{
	Exam_System_Java log =new Exam_System_Java();
		log.login(); 
}
} 